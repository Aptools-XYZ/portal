...
import { AIRDROP_SECTION } from "config/constants";
import CreateForm from "./Form";

const AirdropComp: React.FC = () => {
  const { title, des, steps } = AIRDROP_SECTION;
  return (
    <section className="pt-[110px] md:pt-[200px] airdrop-section-bg overflow-hidden bg-[#F9FCFF] lg:h-[100vh] lg:min-h-[840px]">
